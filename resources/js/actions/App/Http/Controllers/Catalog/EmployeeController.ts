...
/**
* @see \App\Http\Controllers\Catalog\EmployeeController::index
* @see app/Http/Controllers/Catalog/EmployeeController.php:15
...
update.definition = {
    methods: ["put","patch"],
    url: '/catalogs/employees/{employee}',
